...
const sortMeetingsByDay = (arr) => {
  let sorter = { 'monday': 1, 'tuesday': 2, 'wednesday': 3, 'thursday': 4, 'friday': 5, 'saturday': 6 };
  return arr.sort((a, b) => sorter[a.dayOfWeek.toLowerCase()] - sorter[b.dayOfWeek.toLowerCase()] );
};
...
const sortSchedule = (arr) => {
  let sorter = { 'monday': 1, 'tuesday': 2, 'wednesday': 3, 'thursday': 4, 'friday': 5, 'saturday': 6 };
  return arr.sort((a, b) => {
    if(sorter[a.dayOfWeek.toLowerCase()] < sorter[b.dayOfWeek.toLowerCase()]) return -1;
    else if(sorter[a.dayOfWeek.toLowerCase()] > sorter[b.dayOfWeek.toLowerCase()]) return 1;
    else {
